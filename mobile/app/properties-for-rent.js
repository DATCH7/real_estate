...
import { fetchPropertiesForRent, toggleFavorite } from '../utils/apiHelper';
import { getPhotoUrl } from '../utils/photoHelper';

const { width } = Dimensions.get('window');
const cardWidth = width * 0.9; // Each card takes 90% of screen width

export default function PropertiesForRentScreen() {
    ...
    const loadProperties = async () => {
        setLoading(true);
        try {
            console.log('Loading properties for rent...');
                ...
                <View style={styles.propertyDetails}>
                    ...
                    <View style={styles.propertyFeatures}>
                        <View style={styles.featureItem}>
                            ...
                            <Text style={styles.featureText}>{item.price || 'N/A'} DH/month</Text>
                        </View>
        ...
        >
            {properties.length > 0 ? (
                ...
                <View style={styles.emptyContainer}>
                    ...
                    <Text style={styles.emptyText}>No properties available for rent</Text>
                    {isAuthenticated && (
                        <TouchableOpacity
