...
export default function HomeTab() {
    ...
    if (!user) {
        return <Redirect href="/" />;  // Redirect to login screen
    }
    ...
    return (
        <View style={styles.container}>
            <Header
                ...
                subtitle="Your real estate companion"
            />
            ...
            <ScrollView style={styles.scrollView}>
                ...
                <View style={styles.comingSoonContainer}>
                    <TouchableOpacity style={styles.featureCard}>
                        <FontAwesome name="map-marker" size={24} color="#d77710" />
                        <Text style={styles.featureText}>Property Map View</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.featureCard}>
                        <FontAwesome name="calendar" size={24} color="#d77710" />
                        <Text style={styles.featureText}>Property Visits Scheduling</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.featureCard}>
                        <FontAwesome name="comments" size={24} color="#d77710" />
